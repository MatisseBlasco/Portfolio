...
<body>
    <header>
        ...
        <div class="logo">
            <a href="#"><img src="medias/logo-projet-portfolio.webp" alt="Logo"></a>
        </div>
    ...
    <main>
        <div class="btn">
            <img src="medias/scroll-top.png" alt="scroll-top" class="icon">
        </div>
        ...
        <section id="about-me" class="section-about-me">
            ...
            <div class="section-about-me__div">
                <div>
                    <img src="medias/logo-projet-portfolio.webp" alt="logo">
                </div>
